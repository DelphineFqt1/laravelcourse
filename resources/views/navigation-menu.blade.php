<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('welcome') }}">
                        <div class="img">
                            <img src="{{URL::asset('Images/logo_small.png')}}" alt="logo foyz">
                        </div>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('trombi.trombi') }}" :active="request()->routeIs('trombi.trombi')">
                        {{ __('Team') }}
                    </x-jet-nav-link>
                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                    <!-- C'est à cause de ça que le logo de login est un peu décalé vers la droite -->
                    @else
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('trombi.trombi') }}" :active="request()->routeIs('trombi.trombi')">
                {{ __('Team') }}
